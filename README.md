...
# Data
It contains various simulation data generated in Matlab environment (under  <u>Environment_setting <u> file). Researchers can use these data to test the localization algorithms they have developed. 
