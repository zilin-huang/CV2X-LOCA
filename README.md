...
# Data
It contains various simulation data generated in Matlab environment (under $\underline{Environment}$ $\underline{setting}$ file). Researchers can use these data to test the localization algorithms they have developed. 
